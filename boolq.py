...
class BoolQDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        id_values = self.encoded_data[0][i]
        atten_values = self.encoded_data[1][i]
        label_values = self.label_list[i]

        my_dict = {"input_ids": id_values, "attention_mask": atten_values, "labels" :label_valules}
        return my_dict
